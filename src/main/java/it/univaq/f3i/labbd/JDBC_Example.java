...
public class JDBC_Example {
    ...
    private Connect_JDBC_CP connection_module;

    public JDBC_Example(String connection_string, String username, String password) {
        this.connection_module = new Connect_JDBC_CP(connection_string, username, password);
    }
    ...
    public void connect() throws ApplicationException {
        //i due moduli avranno connessioni distinte
        setup_module = new Setup_JDBC(connection_module.newConnection());
        query_module = new Query_JDBC(connection_module.newConnection());
    }
